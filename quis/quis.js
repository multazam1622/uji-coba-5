...
document.addEventListener("DOMContentLoaded", function () {
  ...
  materiLink.addEventListener("click", (event) => {
    dropdown.style.display = dropdown.style.display === "none" ? "flex" : "none";
      ...
      const quizData = [
        {
            question: "1). Dua buah dadu dilempar satu kali. Peluang muncul jumlah mata dadu 10 adalah ...?",
            options: ["A. P = 3/36", "B. P = 4/36", "C. P = 5/36", "D. P = 6/36", "E. P = 7/36"],
            correct: "B"
        },
        {
          question: "2). Dari 1 set kartu bridge diambil 1 kartu. Pluang terambil kartu As adalah ...?",
      ...
      {
        question: "10). Bilangan terdiri dari 3 angka disusun dari angka-angka 2, 3, 5, 6, 7, dan 9. Banyaknya bilangan dengan angka-angka yang berlainan dan yang lebih kecil dari 400 adalah ...?",
        options: ["A. 20", "B. 35", "C. 40", "D. 80", "E. 120"],
        correct: "C"
      },
      {
        question: "11). Andi melemparkan sebuah dadu bermata 6. Hitunglah peluang Andi untuk tidak mendapatkan sisi dadu 3!",
        options: ["A. 2/6", "B. 3/12", "C. 3/6", "D. 5/6", "E. 2/12"],
        correct: "C"
      },
      {
      ...
      {
        question: "21). Dari angka-angka 2, 3, 4, 5, 6, 7, 8, 9 akan dibuat bilangan yang terdiri dari 3 angka berbeda. Banyaknya bilangan berbeda yang lebih besar dari 640 tetapi lebih kecil dari 860 adalah ...?",
        options: ["A. 78", "B. 84", "C. 90", "D. 96", "E. 102"],
        correct: "C"
      },
      {
        question: "21). Presiden, wakil presiden, sekretaris kebinet dan 5 orang menteri duduk pada 8 kursi pada sebuah meja bunder untuk mengadakan rapat kebinet terbatas. Jika sekretaris kebinet harus duduk diantara presiden dan wakil presiden dan wakil presiden, maka banyaknya cara duduk ke-8 orang tersebut adalah ...?",
      ...
      {
        question: "27). Diketahui garis g dan h sejajar. Titik A, B, C, dan D terletak pada garis g. Titik E, F dan G terletak pada garis h. Banyaknya segitiga yang bisa dibuat dari 7 titik tersebut adalah...?",
